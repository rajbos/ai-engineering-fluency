...
<!-- Release notes generated using configuration in .github/release.yml at vscode/v0.16.0 -->
...
* Migrate sharing-server Azure deploy to new tenant via OIDC by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1641
* feat: add friendly names for GitHub MCP (Remote) and Actions Marketplace MCP tools by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1642
* feat(codexcli): add OpenAI Codex CLI ecosystem support by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1643
* refactor(copilot-cli): split getSessionUsage to satisfy complexity lint rules by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1645
* fix(sharing-server): bound auth caches and rate-limit maps by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1646
* ci: skip sharing-server deploy when the push has no sharing-server changes by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1647
* Add test harness and auth unit tests for sharing-server by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1648
* feat(cline): add Cline VS Code extension ecosystem support by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1644
* Add task classification and stacked bar chart by task category by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1651
* Add per-model efficiency metrics and Model Efficiency view (#1649) by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1652
* feat: add 13 friendly tool name(s) from issue #1660 by @github-actions[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1662
* feat: add 3 friendly tool name(s) from issue #1661 by @github-actions[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1663
* Add Sessions histogram metric to Chart view by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1665
* Improve toolNames.json duplicate prevention by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1666
* Show net session duration, keep wall-clock time for future use by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1667
* fix(usage): model efficiency panel — persist through timer, cap cache hit at 100%, move to Activity tab by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1664
* Reconcile modelUsage to actualTokens for event-based sessions by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1668
* Harmonize period selectors across VS Code extension webviews by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1670
* Document VS Code extension UI design as DESIGN.md by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1671
* Distinguish Copilot desktop app sessions from terminal CLI sessions by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1672
* Fix missing workspace in Recent Sessions for Copilot CLI and Claude Desktop by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1669
* chore: bump versions for release (VS Code extension, CLI, JetBrains plugin, Visual Studio extension) by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1673
* Fix custom domain cert reconcile: stale resource address broke hostname re-registration by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1676
* chore: sync model data from rajbos/github-copilot-model-notifier by @github-actions[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1678
* Derive Azure region from the resource group instead of a separate variable by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1677
* Fix fast-uri host confusion vulnerabilities (Dependabot #137, #134) by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1682
* Fix brace-expansion DoS vulnerability (Dependabot #128, #129, #120, #121, #122) by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1683
* Fix js-yaml quadratic CPU consumption vulnerability (Dependabot #130, #123, #119) by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1684
* Have bootstrap Terraform create the resource group in the target region by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1685
* Bootstrap: read resource group via data source, validate region instead of creating it by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1686
* Route GitHub API calls through configured GHE.com/GHES host by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1688
* Support GHE.com as hosting by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1689
* Fix GHE sign-in always redirecting to github.com by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1690
* Show total cost across all providers in details page with filter by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1691
* Left-align tooltip stats table columns by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1695
* feat: add 2 friendly tool name(s) from issue #1693 by @github-actions[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1694
* Detect numeric-suffixed MCP server collision variants in toolnames check by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1697
* Show top 5 editors by default with collapsible Other group by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1696
* Add Share Card tab to Diagnostics panel by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1698
* Fix "Other" group sorting in Usage by Editor/Model tables by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1699
* Fix Share Card tab showing no data after session files load by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1700
* Add loading indicator to Share Card tab by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1702
* feat: add 10 friendly tool name(s) from issue #1692 by @github-actions[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1701
* Add loading indicator to Share Card tab by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1703
* Fix worktree repository attribution showing worktree name by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1704
* Refresh status bar budget flyout after GitHub sign-in by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1707
* Hide Cost by Provider panel when only one provider by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1706
* Fix scanned paths table overflowing diagnostics report panel by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1709
* Keep Copilot Billing Coverage across usage-panel refreshes + regression tests by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1710
* chore: sync model data from rajbos/github-copilot-model-notifier by @github-actions[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1705
* fix: agent-review suggestions for PR #1707 by @github-actions[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1708
* Remove multiplier field from modelPricing.json by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1711
* Fix Scorecard alert #11: patch brace-expansion/tar vulns, add desktop to Dependabot by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1712
* Group npm dependabot updates (minor/patch) for scripts, skills, cli, desktop by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1721
* Fix lowercase "windsurf" label in Share Card and editor filter by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1722
* sharing-server: diagnose org-check failures, admin diagnostics by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1723
* Add period selector and social sharing to Share Card by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1725
* Fix diagnostics table overflow for session folders and scanned paths by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1724
* ci: fix Cleanup Sharing Server approval backlog by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1726
* Fix: run Azure Storage and Team Server sync independently by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1727
* Fix Team Server last-sync timestamp gap and slow Backend Storage panel load by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1728
* Add Hermes Agent editor support by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1729
* feat(types): introduce ModelId type alias for ModelUsage keys by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1730
* feat(types): add thinkingTokens to ModelUsage per-model entry by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1731
* Rebrand team server to AI Engineering Fluency by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1733
* Merge PR #1732: make ModelUsage.sessions required by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1734
* fix(details): show top 5 editors/models by the active sort column by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1735
* Update maturity social share to generate image and copy caption by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1736
* Fix Visual Studio build restore and add vs/v* release workflow by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1737
* Clarify month cost label in Cost by Provider cards by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1740
* Expand default tool families with more real-world tool name variants by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1742
* Fix Input tokens exceeding Total tokens in period stats by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1743
* Add setting to hide automatic tool calls in Tool Usage view by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1744
* Isolate Usage Analysis section render failures from the rest of the dashboard by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1746
* Use subagent/delegation signals in fluency scoring and hints by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1747
* feat: add 9 friendly tool name(s) from issue #1741 by @github-actions[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1745
* Fix lint-toolnames: fetch full history for BASE_SHA diff by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1748
* chore: bump versions for release (vscode, cli, jetbrains, visualstudio) by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/1738
* feat: add 6 friendly tool name(s) from issue #1739 by @github-actions[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1749
### 📦 npm Dependencies
...
* npm(deps): bump @azure/arm-resources-subscriptions from 2.1.0 to 3.0.0 in /vscode-extension by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1657
* npm(deps): bump the minor-and-patch-updates group across 2 directories with 7 updates by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1655
* npm(deps): bump @azure/arm-resources from 7.0.0 to 8.0.0 in /vscode-extension by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1659
* npm(deps-dev): bump shell-quote from 1.8.4 to 1.10.0 in /vscode-extension by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1674
* npm(deps): bump dompurify from 3.4.11 to 3.4.12 in /vscode-extension by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1681
* npm(deps): bump linkify-it from 5.0.1 to 5.0.2 in /vscode-extension by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1679
* npm(deps): bump the minor-and-patch-updates group across 2 directories with 6 updates by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1719
...
* github-actions(deps): bump the minor-and-patch-updates group with 5 updates by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1653
* github-actions(deps): bump actions/setup-python from 6.3.0 to 7.0.0 by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1658
* github-actions(deps): bump actions/setup-node from 6.4.0 to 7.0.0 by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1656
* github-actions(deps): bump the minor-and-patch-updates group with 7 updates by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1720
### 📦 Other Dependencies
...
* gradle(deps): bump jvm from 2.4.0 to 2.4.10 in /jetbrains-plugin in the minor-and-patch-updates group by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1654
* chore(deps-dev): bump tar from 7.5.16 to 7.5.20 in /desktop in the npm_and_yarn group across 1 directory by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1675
* chore(deps-dev): bump fast-uri from 3.1.2 to 3.1.4 in /desktop in the npm_and_yarn group across 1 directory by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1680
* Bump @types/node from 22.20.0 to 26.1.1 in /desktop by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1718
* Bump typescript from 5.9.3 to 7.0.2 in /desktop by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1717
* Bump esbuild from 0.25.12 to 0.28.1 in /desktop by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1715
* Bump chalk from 5.6.2 to 6.0.0 in /cli by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1713
* Bump electron from 42.4.1 to 43.2.0 in /desktop by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1716
* Bump chalk from 5.6.2 to 6.0.0 in /desktop by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/1714


**Full Changelog**: https://github.com/rajbos/ai-engineering-fluency/compare/cli/v0.2.13...vscode/v0.16.0
