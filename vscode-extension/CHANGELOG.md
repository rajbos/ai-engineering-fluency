...
### Bug Fixes
- Insight notifications now take you to the insight, not just to the tab: the toast's "View" action and the status-bar "💡 N insights" badge scroll the Insights tab to the specific card they named and briefly outline it, instead of leaving you to find it among a dozen look-alike cards
