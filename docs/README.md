...
| [features/COPILOT-MEMORY-FILES-INSIGHT.md](features/COPILOT-MEMORY-FILES-INSIGHT.md) | Draft proposal — surface Copilot's on-disk agent memory files (repo/session scope) as a hygiene insight |
