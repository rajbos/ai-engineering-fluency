...
| [features/COPILOT-MEMORY-FILES-INSIGHT.md](features/COPILOT-MEMORY-FILES-INSIGHT.md) | Copilot memory-files hygiene — shared analysis module, insight card, and CLI `memory-files` command (extension.ts wiring pending) |
